...
my (undef, $proto, $status, $head, $body) = Hijk::_read_http_message($fd, 10240, undef, 1);
...
my (undef, $proto, $status, $head, $body, $error, $error_message) = Hijk::_read_http_message($fd, 10240);
